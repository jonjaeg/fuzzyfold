...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("Structure 1: {}", struct1);
    println!("Structure 2: {}", structend);
    println!("Preparing moves from Structure 1 to Structure 2");
    ...
    let (_path_steps, stats) = analyze_folding_path(seq1, struct1, &diff.move_list);
